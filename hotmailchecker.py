...
API_TOKEN = os.getenv('7524506468:AAFB3wNjBvYrdChnuDcIyu0nr70KLnpUpU0')  # Correctly fetch the API token
Admin = os.getenv('ADMINS', '984192016').split(',')
BOT_USERNAME = '@errorxhotbot'
...
def start(message):
    ...
    if chat_id not in subscribers:
        bot.reply_to(message, "Hey! This bot is not free. Ask @Roronoa_robot to get access.")
        return
    ...
    if current_date > expiry_date:
        ...
        bot.reply_to(message, "Drop a combo here and let me do magic 🪄. Do /cmds to view available commands")
...
def generate_code(message):
    ...
    code = f"ＺØＲØ ✘-Ħ Ø ✟ M 𝝙 ⟟ Ł-{random_string}"
