...
API_TOKEN = os.getenv('7341031215:AAHhFHzVVvOh6RRz0qoU-fplo6QaZU06Sv0', '7524506468:AAFB3wNjBvYrdChnuDcIyu0nr70KLnpUpU0')  # Correctly fetch the API token
Admin = os.getenv('ADMINS', '567134933,984192016').split(',')
...
def generate_code(message):
    ...
    code = f"zoro-hotmail-{random_string}"
